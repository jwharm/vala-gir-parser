...
public class VapiBuilder : Gir.Visitor {
    ...
    private static Gir.CallableAttrs? get_invoker_method (Gir.CallableAttrs g_call) {
    ...
    private void add_callable_attrs (Gir.CallableAttrs g_callable_attrs) {
        ...
        /* version */
        v_sym.version.since = g_callable_attrs.version;

        /* deprecated and deprecated_since */
        if (g_callable_attrs.deprecated) {
            /* omit deprecation attributes when the parent already has them */
            var parent = g_callable_attrs.parent_node as Gir.InfoAttrs;
            if (parent == null || !parent.deprecated) {
                v_sym.version.deprecated = true;
                v_sym.version.deprecated_since = g_callable_attrs.deprecated_version;
            }
        }

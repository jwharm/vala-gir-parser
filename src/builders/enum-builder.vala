...
public class Builders.EnumBuilder : IdentifierBuilder {
    ...
    public EnumBuilder (Symbol v_parent_sym, Gir.EnumBase g_enum) {
    ...
    public Symbol build () {
        ...
        /* create error domain */
        if ((g_enum as Gir.Enumeration)?.glib_error_domain != null) {
        ...
        /* create enum */
            ...
            v_sym.set_attribute ("Flags", g_enum is Gir.Bitfield);

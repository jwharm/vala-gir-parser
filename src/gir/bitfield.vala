...
public class Gir.Bitfield : Node, InfoAttrs, DocElements, InfoElements, Identifier, EnumBase {
    ...
    public Bitfield (string name, bool introspectable, bool deprecated,
                     ...
                     Vala.List<Attribute> attributes, string c_type, string? glib_type_name,
                     string? glib_get_type, Vala.List<Member> members,

...
public class Gir.Function : Node, DocElements, InfoElements, InfoAttrs, CallableAttrs, Callable {
    ...
    public Function (string name, bool introspectable, bool deprecated,

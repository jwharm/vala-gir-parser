...
public class Gir.Callback : Node, InfoAttrs, DocElements, InfoElements, Identifier, Callable {
    ...
    public Callback (string name, bool introspectable, bool deprecated,
                     ...
                     Vala.List<Attribute> attributes, bool @throws,
                     Parameters? parameters, ReturnValue? return_value,
                     string c_type) {
            this.name = name;
